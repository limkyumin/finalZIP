...
<body>
		...
		<div class="container">
			<div class="row justify-content-center align-items-center" style="height: 500px;">
				<div class="col-lg-9 text-center mt-5">
					<h1 class="heading" data-aos="fade-up" style="padding-top: 50px;">방등록</h1>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="content">
        ...
        <div class="innerOuter">
            ...
            <form action="register.ro" method="post" enctype="multipart/form-data">
                <div class="form-group">
                
					<input type="hidden" value="${loginUser.userNo }" name="userNo">                
                	
                    <label for="title">* 제목 : </label>
                    <input type="text" class="form-control" id="title" placeholder="제목을 입력하세요" name="title" required> <br>
					
					<label for="">* 건물유형 : </label> &nbsp;&nbsp;
                    <input type="radio" id="apartment" value="아파트" name="buildingType" checked>
                    <label for="apartment">아파트</label> &nbsp;&nbsp;
                    <input type="radio" id="villa" value="빌라" name="buildingType">
                    <label for="villa">빌라</label> &nbsp;&nbsp;
                    <input type="radio" id="housing" value="주택" name="buildingType">
                    <label for="housing">주택</label> &nbsp;&nbsp;<br><br>
                    
                    <label for="buildingLevel">* 층수 : </label>
                    <input type="number" class="form-control" id="buildingLevel" placeholder="층수를 입력하세요(숫자만)" name="buildingLevel" required> <br>

                    <label for="tenantNumber">* 총 하우스메이트 인원수 : </label>
                    <input type="number" class="form-control" id="tenantNumber" placeholder="인원수를 입력하세요(숫자만)" name="tenantNumber" required> <br>
                    ...
                    <input type="text" class="form-control" id="addressDetail" placeholder="상세 주소를 입력하세요(예 : XX동 YY호만 )" name="addressDetail" required> <br>
					
					<label for="">* 선호 성별 :   &nbsp;</label> &nbsp;&nbsp;
                    <input type="radio" id="Male" value="남성" name="wishGender" checked>
                    <label for="Male">남성</label> &nbsp;&nbsp;
                    <input type="radio" id="Female" value="여성" name="wishGeender">
                    ...
                    <input type="radio" id="thirties" value="30대" name="wishAge">
                    <label for="thirties">30대</label> &nbsp;&nbsp;
                    <input type="radio" id="noProblem" value="무관" name="wishAge">
                    ...
                    <input type="radio" id="petN" value="불가" name="petYn">
                    <label for="petN">불가</label> &nbsp;&nbsp;<br><br>
                    
                    <label for="">* 흡연자 :   &nbsp; &nbsp; &nbsp;</label> &nbsp;&nbsp;
                    <input type="radio" id="smokeY" value="가능" name="smokeYn" checked>
                    <label for="smokeY">가능</label> &nbsp;&nbsp;
                    <input type="radio" id="smokeN" value="불가" name="smokeYn">
                    <label for="smokeN">불가</label> &nbsp;&nbsp;<br><br>
					
					<label for="upfile">* 사진파일</label>
					<input type="file" multiple="multiple" id="upfile1" class="form-control-file border" name="upfile1" required> <br>
					
					<label for="upfile2">* 주택임대차계약서 사본</label>
					<input type="file" id="upfile2" class="form-control-file border" name="upfile2" required> <br>
					
                    <label for="phone">* 한달 방세 : </label>
                    <input type="number" class="form-control" id="phone" placeholder="숫자만 입력하세요(단위 : 만원)" name="price" required> <br>
                    
                    <label for="address">* 내용 : </label>
                    <textarea class="form-control" rows="5" id="comment" placeholder="내용을 입력하세요" name="content" required></textarea> <br>
                    
                </div>
                <br>
                <div class="btns" align="center">
                    <button type="submit" class="btn btn-primary" style="background-color: #2D55C9;">방등록</button>
