...
<body>
		...
		<div class="container">
			<div class="row justify-content-center align-items-center" style="height: 500px;">
				<div class="col-lg-9 text-center mt-5">
					<h1 class="heading" data-aos="fade-up" style="padding-top: 50px;">입주후기 수정</h1>
				</div>
			</div>
		</div>
	...
	<div class="content">
		...
		<div class="innerOuter">
			...
			<form id="enrollForm" method="post" action="update.re">
				<table align="center">
					<tr>
						<th><label for="title">제목</label></th>
						<td><input type="text" id="title" class="form-control" name="reviewTitle" value="${r.reviewTitle }" required></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><textarea id="content" class="form-control" rows="10" style="resize: none;" name="reviewContent" required>
							${r.reviewContent }
						</textarea></td>
					</tr>
				</table>
				...
				<div align="center">
					...
					<button type="submit" id="update" class="btn btn-primary" onclick="contentNotNull();">수정하기</button>
