		...
		<div class="container">
			<div class="row justify-content-center align-items-center" style="height: 500px;">
				<div class="col-lg-9 text-center mt-5">
					<h1 class="heading" data-aos="fade-up" style="padding-top: 50px;">신고하기 작성</h1>
				</div>
			</div>
		</div>
			...
			<form id="enrollForm" method="post" action="insert.in" enctype="multipart/form-data">
				<table align="center">
					...
					<tr>
						...
						<td><input type="text" id="reportWriter" class="form-control" value="${userId }" name="reportId" readonly></td>
					</tr>
					<tr>
